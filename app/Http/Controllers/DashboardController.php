...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $dashboardData = CacheService::cacheDashboard($user, $selectedMonth, function () use ($user, $year, $month, $selectedMonth) {
            ...
            return compact('totalIncome', 'totalExpense', 'expenseByCategory', 'incomeByCategory', 'budgetProgress');
        });
