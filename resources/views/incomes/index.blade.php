    ...
    <div id="editIncomeModal" class="modal-overlay" style="display: none;" onclick="closeModal('editIncomeModal')">
        <div class="modal-content" onclick="event.stopPropagation()">
            ...
            <form id="editIncomeForm" method="POST">
                ...
                <input type="number" id="editIncomeAmount" name="amount" required min="0.01" step="0.01" />
                ...
                <input type="date" id="editIncomeDate" name="date" required />

                <label for="editIncomeNote">Note:</label>
                <input type="text" id="editIncomeNote" name="note" placeholder="Source (e.g.: November Salary)" />
